...
#### 15.1.3 Make sure to include the header
...
```{r, eval=FALSE}
dat <- read.csv("C:/Users/Flavio/Documents/Courses/R/Data/aids.csv")
```

### 15.3 Load in R a dataset file from a url

```{r, eval=FALSE}
read.table("http://data.princeton.edu/wws509/datasets/effort.dat")
```

### 15.4 Load in R Excel Files
...
#### 15.6.1 To A Tab Delimited Text File

```{r, eval=FALSE}
write.table(mydata, "c:/mydata.txt", sep="\t")
```

####  15.6.2 To an Excel Spreadsheet
