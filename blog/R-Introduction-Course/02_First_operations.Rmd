...
Store the number 0.0001 under the name "small.num" (i.e. put 0.0001 into small.num)
...
#### **Scalar Variables**. Every object in R has a type - all the variables we created are termed scalar. Scalar variable is a single number variable. x is a scalar variable whose value is 103, small.num is a scalar variable whose value is 0.001 and so forth.
